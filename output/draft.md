...
The conventional wisdom had a diagnosis ready: I wasn't resilient enough. I needed to meditate more, exercise more, *bounce* more. But the conventional wisdom was wrong. The resilience wasn't saving me. It was the thing that kept me in the fire long after I should have walked out.
...
A 2023 study published in *Emotion* tracked participants through repeated stressors and measured something called executive function — the cognitive resource that handles decision-making, emotional regulation, and impulse control. The finding? High-resilience individuals didn't bounce back faster. They showed *greater* cognitive depletion after each stressor cycle. They were burning more fuel to keep performing "okay," and the tank was emptying faster than anyone realized.

Think of it like a car with a broken fuel gauge. Resilience training teaches you to ignore the warning light and keep driving. The engine doesn't actually get more efficient — you're just running on fumes until you're stranded.
...
Here's where the whole framework collapses: humans didn't evolve to be resilient to *chronic* stress. Our stress response systems — cortisol, adrenaline, the hypothalamic-pituitary-adrenal axis — are designed for acute threats. Saber-toothed tiger. Run. Survive. Rest.

Chronic stress — the kind that comes from jobs, relationships, and systems — isn't a saber-toothed tiger. It's a slow leak. And the evolutionary machinery that handles acute threats actually breaks down when the threat never ends. You can't out-breathe a toxic workplace any more than you can out-run a background radiation leak.
...
This is the resilience trap. It shifts responsibility from systems to individuals. It tells the single mother working three jobs that she needs more grit, not better wages. It tells the burned-out doctor that she needs a meditation app, not safer staffing ratios. It creates what the *New Yorker* piece calls a "blame the victim culture disguised as empowerment."
...
Visakan Veerasamy, a writer I've learned from, calls quitting "the most underrated growth skill." He frames it as pattern recognition — the ability to see that continued effort in a broken system is not perseverance but a failure of discernment. The people who thrive aren't the ones who endure everything. They're the ones who know when to stop enduring.
